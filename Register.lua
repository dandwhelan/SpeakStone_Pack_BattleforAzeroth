...
if QuestReaderAddon_RegisterSoundPack then
    QuestReaderAddon_RegisterSoundPack(addonName, QuestReaderSoundLengths_Pack_BattleforAzeroth)
else
    QuestReaderPendingSoundPacks = QuestReaderPendingSoundPacks or {}
    table.insert(QuestReaderPendingSoundPacks,
        { name = addonName, index = QuestReaderSoundLengths_Pack_BattleforAzeroth })
end
